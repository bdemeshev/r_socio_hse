...
<span style="color:red">Отключение электричества на Шаболовке 9/11 нас не касается :) Занятия по расписанию! </span>

* 12 мая 2017, ауд. 320а. LASSO, авто-ARIMA, взвешенная регрессия. Пожалуйста, поставьте заранее пакеты `forecast`, `sophisthse`, `forecastHybrid`, `glmnet`, `survey`, `listviewer`, `gapminder`. 

* 17 мая 2017, ауд. 324. Иерархические модели — начало.
