...
* 17 марта 2017. Установка R, Rstudio. Где найти справку. Загрузка .csv файлов. Отбор переменных, сортировка, описательные статистики. Создание векторов. NA/NaN. Файлы: [script_01.R](https://github.com/bdemeshev/r_socio_hse/raw/master/script_01.R) и [домашка-1](https://github.com/bdemeshev/r_socio_hse/raw/master/ht_01.pdf).

План:

* 24 марта 2017. Отбор наблюдений, группировка данных, работа с факторными переменными. Если успеем: стратегия "Разделяй и властвуй" (split-apply-combine strategy). 
