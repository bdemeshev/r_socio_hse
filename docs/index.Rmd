...
* 12 мая 2017, ауд. 320а. LASSO, авто-ARIMA, взвешенная регрессия. Пожалуйста, поставьте заранее пакеты `forecast`, `sophisthse`, `forecastHybrid`, `glmnet`.

* 17 мая 2017, ауд. ???. Иерархические модели — начало.
