...
* 24 марта 2017, ауд. 320а. Отбор наблюдений, группировка данных, работа с факторными переменными. Если успеем: стратегия "Разделяй и властвуй" (split-apply-combine strategy). 

* 29 марта 2017, ауд. 320а. Визуализация данных

* 31 марта 2017, ауд. 320а. Визуализация данных. Грамотное программирование

* 05 апреля 2017, ауд. 320а. Грамотное программирование. Презентации.

* 07 апреля 2017, ауд. 320а.  Множественная регрессия
...
* [R + Rstudio](https://github.com/bdemeshev/installation/raw/master/docs/r/R_installation.html)
