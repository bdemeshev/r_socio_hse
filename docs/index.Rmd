...
<span style="color:red">Отключение электричества на Мясницкой 9/11 нас не касается :) Занятия по расписанию! </span>

* 12 мая 2017, ауд. 320а. LASSO, авто-ARIMA, взвешенная регрессия. Пожалуйста, поставьте заранее пакеты `forecast`, `sophisthse`, `forecastHybrid`, `glmnet`, `survey`, `listviewer`, `gapminder`. [report_4.Rmd](https://github.com/bdemeshev/r_socio_hse/raw/master/report_4.Rmd).
