...
* <span style="color:red">Встречи 7 апреля НЕ БУДЕТ!</span> 
~~07 апреля 2017, ауд. 320а. Множественная регрессия. Графики~~. [script_04.R](https://github.com/bdemeshev/r_socio_hse/raw/master/script_04.R)


* 19 апреля 2017, <span style="color:red">ауд. 326.</span> Грамотное программирование.

* 21 апреля 2017, ауд. 319а. Презентации.
