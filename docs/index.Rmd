...
* 28 апреля 2017, ауд. 320а.  Грамотное программирование — окончание. R с менюшками: radiant, мелкие помощники addins: [report_3.Rmd](https://github.com/bdemeshev/r_socio_hse/raw/master/report_3.Rmd).

План:

* 12 мая 2017, ауд. 524 на <span style="color:red">Мясницкой 20.</span> LASSO, авто-ARIMA, взвешенная регрессия. Пожалуйста, поставьте заранее пакеты `forecast`, `sophisthse`, `forecastHybrid`, `glmnet`, `survey`, `listviewer`, `gapminder`.

* 17 мая 2017, ауд. 524 на <span style="color:red">Мясницкой 20.</span> Иерархические модели — начало.

* 19 мая 2017, ауд. 320а.  Иерархические модели — окончание. Вопросы-ответы.

Основное место: Мясницкая 9/11. Приносите свои ноутбуки!!
...
3. Оценить не менее 1 (одной)  регрессии.
